...
export default function Home() {
  return <main>
    ...
    <section className="intro shell" id="about">
      ...
      <div className="introCopy"><h2>I build the systems<br/>behind the experience.</h2><p>I’m Cristian Gîrlea, an engineer and technical lead with 12+ years across fintech, AI, cybersecurity and enterprise platforms. My focus is clear: production-grade services, calm incident response, and teams that understand the systems they operate.</p>
