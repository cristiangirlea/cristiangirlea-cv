...
const experience = [
  { period: "Dec 2025 - Present", company: "Netcraft", role: "Senior Platform Engineer", title: "Distributed Processing & Intelligence Systems", detail: "Building and modernizing distributed systems across a large Node.js, Go and Perl ecosystem on AWS, with Beanstalkd job queues, Kubernetes development environments using Skaffold and Minikube, Grafana observability, service integrations, and Python end-to-end testing.", tag: "Cybersecurity Platform" },
