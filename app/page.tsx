const experience = [
  { period: "Dec 2025 — Present", company: "Netcraft", role: "Senior Platform Engineer", title: "Distributed Crawling & Social Processing", detail: "Building TypeScript and Go services for large-scale social and web intelligence pipelines, with Kubernetes environments and Protobuf integrations.", tag: "Platform" },
...
export default function Home() {
  return <main>
    ...
    <section className="hero shell" id="top">
      ...
      <div className="signal" aria-hidden="true"><div className="orbit"/><div className="orbit orbitTwo"/><div className="signalCore"><span>12+</span><small>years<br/>engineering</small></div><b className="labelOne">PLATFORM</b><b className="labelTwo">BACKEND</b><b className="labelThree">CLOUD</b></div>
    </section>
    <section className="intro shell" id="about">
      <div className="sectionLabel">01 / Profile</div>
      <div className="introCopy"><h2>I build the systems<br/>behind the experience.</h2><p>I’m Cristian Gîrlea, a Bucharest-based engineer and technical lead with 12+ years across fintech, AI, cybersecurity and enterprise platforms. My focus is clear: production-grade services, calm incident response, and teams that understand the systems they operate.</p>
